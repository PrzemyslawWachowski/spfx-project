define("2d8b7e2f-7c1a-4e54-9058-5ec8b8644708_0.0.1", ["@microsoft/sp-property-pane","@microsoft/sp-core-library","@microsoft/sp-webpart-base","HelloWorldWebPartStrings","@microsoft/sp-http"], function(__WEBPACK_EXTERNAL_MODULE__26ea__, __WEBPACK_EXTERNAL_MODULE_UWqr__, __WEBPACK_EXTERNAL_MODULE_br4S__, __WEBPACK_EXTERNAL_MODULE_hI9z__, __WEBPACK_EXTERNAL_MODULE_vlQI__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var sp_pnp_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! sp-pnp-js */ "7kAN");
/* harmony import */ var sp_pnp_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(sp_pnp_js__WEBPACK_IMPORTED_MODULE_5__);
...
var HelloWorldWebPart = /** @class */ (function (_super) {
    ...
    HelloWorldWebPart.prototype.onInit = function () {
        ...
        return _super.prototype.onInit.call(this).then(function (_) {
            sp_pnp_js__WEBPACK_IMPORTED_MODULE_5__["setup"]({
    ...
    HelloWorldWebPart.prototype.deleteListItem = function () {
        ...
        sp_pnp_js__WEBPACK_IMPORTED_MODULE_5__["sp"].web.lists.getByTitle("Kontakty").items.getById(id).delete();
    ...
    HelloWorldWebPart.prototype.updateListItem = function () {
        ...
        void this.context.spHttpClient.post(siteurl, _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_4__["SPHttpClient"].configurations.v1, spHttpClientOptions)
            .then(function (response) {
            // eslint-disable-next-line @typescript-eslint/no-floating-promises
    ...
    HelloWorldWebPart.prototype._getListItemByID = function (ID) {
        ...
        return this.context.spHttpClient.get(url, _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_4__["SPHttpClient"].configurations.v1)
            .then(function (Response) {
    ...
    HelloWorldWebPart.prototype.addListItem = function () {
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.context.spHttpClient.post(siteurl, _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_4__["SPHttpClient"].configurations.v1, spHttpClientOptions)
            .then(function (response) {
            // eslint-disable-next-line @typescript-eslint/no-floating-promises
            response.json().then(function (responseJson) {
                console.log(responseJson); // Wyświetl treść odpowiedzi JSON
